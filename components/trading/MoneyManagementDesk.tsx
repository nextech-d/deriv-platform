...
export function MoneyManagementDesk({
  signedIn = false,
  formatLocal = dollars,
}: MoneyManagementDeskProps) {
  ...
  return (
    <div data-testid="money-mgmt-desk" data-desk className="money-mgmt" data-scroll-pane>
      <header className="money-mgmt-toolbar">
        ...
        <div className="money-mgmt-toolbar-status">
          ...
          <span className={cn("money-mgmt-chip", hits > 0 && "is-hit")}>
              ...
              <tbody>
                {rows.map((row) => (
                  <tr
                    ...
                    className={cn(
                      row.achieved && "is-hit",
                      row.actualProfit !== "" && !row.achieved && "is-miss",
                    )}
                  >
                    <td>{row.day}</td>
                    ...
                    <td>
                      <span
                        className={cn(
                          "money-mgmt-flag",
                          row.actualProfit !== "" && (row.achieved ? "is-yes" : "is-no"),
                        )}
                      >
